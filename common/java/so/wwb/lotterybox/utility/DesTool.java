...
public class DesTool {
    ...
    public static void main(String[] args){
        ...
        String username = "ronnie_api";
        map.put("username",username);
        String password = "200";
        map.put("money",password);
        //map.put("codeId",username.substring(0,4)+"21");
        System.out.println(map.toString());
        String encryp = CryptoTool.encryptDES3(JSONObject.toJSON(map).toString(),"EM1HCSERVRATODU");
        ...
        String decrypt = CryptoTool.decryptDES3(encryp, "EM1HCSERVRATODU");
