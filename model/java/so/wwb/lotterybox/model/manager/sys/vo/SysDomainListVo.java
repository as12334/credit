...
//endregion your codes 1
    ...
    public static class SysDomainQuery extends AbstractQuery<SysDomainSo> {
        ...
        public Criteria getCriteria() {
            ...
            criteria.addAnd(SysDomain.PROP_TYPE, Operator.EQ, searchObject.getType());
            ...
            //列表页过滤掉总代，代理域名
            if(searchObject.getType()==null || "".equals(searchObject.getType())){
                criteria.addAnd(SysDomain.PROP_SUBSYS_CODE, Operator.NE, SubSysCodeEnum.DISTRIBUTOR.getCode());
                criteria.addAnd(SysDomain.PROP_TYPE, Operator.NE, DomainTypeEnum.PLAYER_AGENT.getCode());
            }
            return criteria;
        }
