...
//endregion your codes 1
    ...
    public static class SysUserExtendQuery extends AbstractQuery<SysUserExtendSo> {
        ...
        public Criteria getCriteria() {
            ...
            criteria.addAnd(SysUserExtend.PROP_PARENT_IDS, Operator.LIKE_S, searchObject.getParentIds());
            criteria.addAnd(SysUserExtend.PROP_OWNER_CODE,Operator.EQ,searchObject.getOwnerCode());
            ...
            criteria.addAnd(SysUserExtend.PROP_OWNER_NAME,Operator.LIKE,searchObject.getOwnerName());
            //子账号
