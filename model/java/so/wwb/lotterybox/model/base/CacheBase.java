...
//    }
//
//    public static Map<String, LotteryOddSet> getOddSet(Integer siteId, String code) {
//        Map<String, LotteryOddSet> map = CacheTool.get(CacheKey.getCacheKey(CacheKey.CACHE_KEY_LOTTERY_ODD_SET, siteId.toString(), code));
//        if (MapTool.isEmpty(map)) {
...
//     * 根据彩种获取站点赔率设置
//     */
//    public static Map<String, LotteryOddSet> getOddSet(String code) {
//        if (StringTool.isBlank(code)) {
//            return null;
//        }
//        log.info("站点SessionManagerBase.getSiteId：{0}，彩种code:{1},用户名：{2}",SessionManagerBase.getSiteId(), code,SessionManagerBase.getUserName());
//        return getOddSet(SessionManagerBase.getSiteId(), code);
//    }
//
//    /** 刷新赔率缓存 */
