...
//    USER_ACCOUNT_PLAYER_ADD("108","新增代理/玩家账号"),
...
////    USER_STATUS_DISABLE("116", "停用账号"),
////    USER_STATUS_NORMAL("117", "启用账号"),
...
//    PLAYER_AGENT_UPDATE("126","修改玩家代理"),
//
//    USER_BANKCARD_ADD("140","新增银行卡"),
//    USER_BANKCARD_UPDATE("141","修改银行卡"),
...
//    CALL_REPORT_OPERATE("453", "手动执行运营报表函数"),
//
//
...
//
//    CONTENT_SITE_AGENT_DOMAIN_ADD("654","新增代理域名"),
////    CONTENT_SITE_AGENT_DOMAIN_DELETE("655","删除代理域名"),
//    CONTENT_SITE_AGENT_DOMAIN_UPDATE("656","编辑代理域名"),
