...
//        if (UserTypeEnum.MERCHANT.getCode().equals(getUser().getUserType())) {
...
//        if (getUser().getUserType().equals(UserTypeEnum.MERCHANT.getCode())) {
...
//                if (sysUser.getUserType().equals(UserTypeEnum.MERCHANT.getCode())) {
