...
//
//    /** 获取站点彩票赔率缓存 */
//    public static Map<String,LotteryOddSet> getLotteryOdds(String code) {
//        Map<String, LotteryOddSet> map = getOddSet(code);
//        if (map == null) {
...
//    }
//
//    public static void refreshLotteryOddSet() {
//        Integer siteId = SessionManagerBase.getSiteId();
//        refreshLotteryOddSet(siteId);
//    }
//
//    public static void refreshLotteryOddSet(Integer siteId) {
//        CacheTool.refresh(CacheKey.getCacheKey(CacheKey.CACHE_KEY_LOTTERY_ODD_SET, Integer.toString(siteId)));
//    }
//
