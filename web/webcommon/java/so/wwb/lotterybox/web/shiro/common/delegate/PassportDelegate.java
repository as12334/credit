...
public class PassportDelegate implements IPassportDelegate {
    ...
    public Integer getEntranceType(String contextPath, String uri) {
        ...
        if (SubSysCodeEnum.DISTRIBUTOR.getCode().equals(subsysCode)) {
            return PassportVo.AGENT;
        }
        if (SubSysCodeEnum.DISTRIBUTOR.getCode().equals(subsysCode)) {
            return PassportVo.TOP_AGENT;
        }
        if (SubSysCodeEnum.HALL.getCode().equals(subsysCode)) {
            return PassportVo.PLAYER;
        }
        return PassportVo.NORMAL;
    }
    ...
    public String getLoginUrl(Integer entranceType) {
        ...
        }else if (PassportVo.PLAYER.equals(entranceType)){
            return hallLogout;
        }
        return ssoNormal;
    }
